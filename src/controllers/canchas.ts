...
export const canchasGet = (req:Request, res:Response) =>{
    res.json({ok:true, canchas});
}

export const canchasGetById = (req:Request, res:Response) =>{
...
export const canchasPost = (req:Request, res:Response) =>{
...
export const canchasPut = (req:Request, res:Response) =>{
    const {id} = req.params;   // Desestructura 'id' desde req.params para usarlo directamente
...
export const canchasDelete = (req: Request, res: Response) => {
...
export const canchasPatch = (req: Request, res: Response) => {
    const { id } = req.params;   // Desestructura 'id' desde req.params para usarlo directamente
